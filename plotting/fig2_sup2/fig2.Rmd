...
final_df_rest$structural_category <- factor(final_df_rest$structural_category, levels = c(levels(final_df$structural_category), "Others"))
top_categories <- c("FSM", "NIC", "NNC", "ISM")
final_df_rest[!final_df_rest$structural_category %in% top_categories, "structural_category"] <- "Others"
...
ggsave(filename = "complettness_supp.svg", final_p_supp_completness, height = 5, width = 6.5)
ggsave(filename = "complettness_supp.jpeg", final_p_supp_completness, height = 5, width = 6.5)
ggsave( filename = "gene_sets.jpeg", final_p, height = 5, width = 6)
ggsave(filename = "gene_sets.svg", final_p, height = 5, width = 6)
```
